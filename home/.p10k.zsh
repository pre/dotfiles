# Generated by Powerlevel10k configuration wizard on 2020-02-03 at 17:25 EET.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='_rex_safe|rex|k|kubectl|helm|kubens|kubectx|oc'
