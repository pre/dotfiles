# Generated by Powerlevel10k configuration wizard on 2020-02-04 at 11:28 EET.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 2107.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # Hide dir clutter https://github.com/romkatv/powerlevel10k/issues/430#issuecomment-577704099
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='_rex_safe|rex|k|kubectl|kns|kctx|execpod|tailpod|findpod|describepod|pfpod|helm|kubens|kubectx|oc'
